...
To install and use TBEEAM (forked from BEEAM) with a graphical Modelica simulation environment (OpenModelica, Dymola, Wolfram System Modeler, MapleSim, etc.), follow these instructions:

1. Download TBEEAM by cloning this repository (for legacy upstream releases, see [release](https://github.com/NREL/DC-Design/releases/))
