...
model Resistor "Resistive element"
  ...
  Modelica.Units.SI.Power Preal=sum(Modelica.ComplexMath.real(v[:] .*
      Modelica.ComplexMath.conj(i[:])));
equation
/*
  ...
  */
  ...
  annotation (
    ...
    Icon(coordinateSystem(grid = {0, 0}, initialScale = 0.1), graphics = {Rectangle(lineColor = {92, 53, 102}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-70, 30}, {70, -30}}), Line(origin = {85, 0}, points = {{-15, 0}, {15, 0}}, color = {92, 53, 102}), Line(origin = {-85.07, -0.21}, points = {{-15, 0}, {15, 0}}, color = {92, 53, 102}), Text(origin = {-4, -20}, lineColor = {92, 53, 102}, extent = {{-150, 60}, {150, 100}}, textString = "%name"), Text(origin = {-4, -140}, extent = {{-150, 60}, {150, 100}}, textString = "R = %r")}),
    Diagram(coordinateSystem(extent = {{-200, -200}, {200, 200}}, grid = {0, 0})),
    Documentation(info = "<html>
<p>Linear resistive element. </p>
</html>"));
end Resistor;
