...
model Scenario_6_Data_Set_6_3
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl NextekHub(P1(start = 1500), S1(start = 1500),  V_Rect = 25, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Nextek-PHD16-ACDC-DIM-P-24-6-208V.mat", nomP = 1600, nomV = 208) annotation (
  ...
  DC.DC_Load Laptop_6(pwr = 41.643) annotation (
  ...
  DC.DC_Load Laptop_5(pwr = 40.457) annotation (
  ...
  DC.DC_Load Laptop_4(pwr = 41.983) annotation (
...
equation
  ...
  connect(deltaWye.pinSec_C, terminate1.hPin_P) annotation (
    Line(points = {{-86, 0}, {-61, 0}}, color = {92, 53, 102}));
  connect(deltaWye.pinSec_B, NextekHub.hPin_N) annotation (
    Line(points = {{-86, 8}, {-40, 8}, {-40, 4}, {-12, 4}}, color = {92, 53, 102}));
  annotation (
