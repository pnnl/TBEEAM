...
model Scenario_5_Data_Set_5_2
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl NextekHub(P1(start = 200), S1(start = 200),  V_Rect = 25, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Nextek-PHD16-ACDC-DIM-P-24-6-120V.mat", nomP = 1600, nomV = 120) annotation (
  ...
  HPF.DC.DC_Load Laptop_6(pwr = 6.835) annotation (
  ...
  HPF.DC.DC_Load Laptop_4(pwr = 5.766) annotation (
...
equation
  ...
  connect(deltaWye.pinSec_B, terminate1.hPin_P) annotation (
    Line(points = {{-86, 8}, {-73, 8}}, color = {92, 53, 102}));
  connect(deltaWye.pinSec_C, terminate2.hPin_P) annotation (
    Line(points = {{-86, 0}, {-73, 0}}, color = {92, 53, 102}));
