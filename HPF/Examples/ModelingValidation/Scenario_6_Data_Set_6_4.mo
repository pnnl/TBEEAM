...
model Scenario_6_Data_Set_6_4
  ...
  DC.DC_Load Laptop_6(pwr = 71.658) annotation (
  ...
  DC.DC_Load Laptop_5(pwr = 71.073) annotation (
  ...
  DC.DC_Load Laptop_4(pwr = 73.770) annotation (
  ...
  DC.DC_Load LumpedDCLoads(pwr = 666.268) annotation (
