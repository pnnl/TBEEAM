...
model Scenario_5_Data_Set_5_1
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl NextekHub(P1(start = 50), S1(start = 50),  V_Rect = 25, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Nextek-PHD16-ACDC-DIM-P-24-6-120V.mat", nomP = 1600, nomV = 120) annotation (
  ...
  HPF.SinglePhase.Components.Terminate terminate1
    annotation (Placement(transformation(extent={{-78,2},{-64,16}})));
  HPF.SinglePhase.Components.Terminate terminate2
...
equation
  ...
  annotation (
    Diagram(coordinateSystem(extent = {{-280, -220}, {260, 240}}, initialScale = 0.1), graphics={Text(lineColor = {28, 108, 200}, extent = {{-256, 64}, {-250, 64}}, textString = "Edit Here"),
                                                  Text(origin = {-26, 96}, lineColor = {28, 108, 200}, extent = {{174, -126}, {234, -146}}, textString = "PhD 25V outputs
    ")}),
