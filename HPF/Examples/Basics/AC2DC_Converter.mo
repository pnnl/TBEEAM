...
model AC2DC_Converter
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl ACDC_Converter(P_DCmin = 2.5, P_stby = 1,V_Rect = 24, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/osram.mat", nomP = 30, nomV = 120) annotation (
    Placement(visible = true, transformation(origin = {30, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.DC.DC_Load dC_Load(pwr = 25) annotation (
