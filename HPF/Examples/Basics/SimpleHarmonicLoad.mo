...
model SimpleHarmonicLoad
  ...
  HPF.SinglePhase.Sources.CurrentSource harmonicLoad(iMag = {11.3802, 6.6631, 1.8123, 1.3356, 0.6466, 0.5229}, iArg = {0.351, -2.0293, 2.4134, 1.5971, -0.068, -0.7582}) annotation (
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {26, 24})));
equation
  ...
  connect(Z01.pin_n, harmonicLoad.pin_p) annotation (
    Line(points = {{6, 44}, {26, 44}, {26, 34}}, color = {117, 80, 123}));
  connect(harmonicLoad.pin_n, ground.pin) annotation (
    Line(points = {{26, 14}, {26, 2}, {-28, 2}, {-28, -6.75}}, color = {117, 80, 123}));
  annotation (
