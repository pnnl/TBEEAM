...
model DC2DC_Converter
  ...
  parameter Data.ConverterModels.DC2DC_StepDown.Laptop_18V_90W_LapChrg4 modelData1(Pnom = 5) annotation (
  ...
  DC.DC2DC_Converters.StepDown stepDown(modelData = modelData1) annotation (
    Placement(visible = true, transformation(extent = {{-14.0,20.0},{6.0,40.0}}, rotation = 0.0,origin = {0.0,0.0})));
  ...
  Modelica.Electrical.Analog.Sources.ConstantVoltage constantVoltage(V = 380) annotation (
    Placement(visible = true, transformation(origin = {-54, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
equation
