...
model AC2DC_Simple_Rectifier_1P
  ...
  HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Simple_Rectifier(P_DCmin = 5,P_nom = 100, P_stby = 0, VAC_nom = 120, VDC_nom = 24, alpha = 0.01, beta = 0.02, gamma = 0.03)  annotation (
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp DC_Power_Schedule(duration = 2, height = 100, offset = 0, startTime = 0) annotation (
