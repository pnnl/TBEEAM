...
model DC_DC_MPPT
  ...
  parameter .Modelica.Units.SI.Power P_nom = 1000 "Nominal power" annotation (
    Dialog(group = "Device Ratings"));
  parameter .Modelica.Units.SI.Voltage VDC_nom = 380 "Nominal DC operating voltage" annotation (
    Dialog(group = "Device Ratings"));
