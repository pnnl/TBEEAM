...
model medoff_template_3
    ...
    replaceable parameter .HPF.Templates.Data.Examples.medium_office_light_mel_ACconDCloads_SD modelData annotation(Placement(transformation(extent = {{-86.0,74.0},{-66.0,94.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Templates.LoadwStepDown lum_phaseA[modelData.nStepDown_lumA](redeclare replaceable .HPF.DC.DC2DC_Converters.StepDown dcdc_Converter, modelData=
         modelData.lum_phaseA) annotation(Placement(transformation(extent = {{130.0,10.0},{150.0,30.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModelDC nEC_CableModelDC[modelData.nStepDown_lumA] annotation(Placement(transformation(extent = {{93.19999999999999,18.0},{113.19999999999999,38.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModelDC nEC_CableModelDC2[modelData.nStepDown_lumB] annotation(Placement(transformation(extent = {{92.0,-21.25},{112.0,-1.25}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModel nEC_CableModel5[modelData.nconverter_lumB](wireGaugeAC = .HPF.Types.WireGaugeAC.gauge_12) annotation(Placement(transformation(extent = {{34.0,-24.75},{54.0,-4.75}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModelDC nEC_CableModelDC3[modelData.nStepDown_lumC] annotation(Placement(transformation(extent = {{92.0,-56.5},{112.0,-36.5}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModelDC nEC_CableModelDC4[modelData.nStepDown_melA] annotation(Placement(transformation(extent = {{203.3411764705882,121.11764705882354},{223.3411764705882,141.11764705882354}},origin = {0.0,0.0},rotation = 0.0)));
    .HPF.Cables.NEC_CableModel nEC_CableModel10[modelData.nconverter_melA](wireGaugeAC = .HPF.Types.WireGaugeAC.gauge_12) annotation(Placement(transformation(extent = {{148.14117647058822,119.11764705882354},{168.14117647058822,139.11764705882354}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModelDC nEC_CableModelDC5[modelData.nStepDown_melB] annotation(Placement(transformation(extent = {{202.14117647058822,82.61764705882354},{222.14117647058822,102.61764705882354}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModel nEC_CableModel11[modelData.nconverter_melB](wireGaugeAC = .HPF.Types.WireGaugeAC.gauge_12)  annotation(Placement(transformation(extent = {{144.14117647058822,79.11764705882354},{164.14117647058822,99.11764705882354}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModelDC nEC_CableModelDC6[modelData.nStepDown_melC] annotation(Placement(transformation(extent = {{202.14117647058822,46.61764705882353},{222.14117647058822,66.61764705882354}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Cables.NEC_CableModel nEC_CableModel12[modelData.nconverter_melC](wireGaugeAC = .HPF.Types.WireGaugeAC.gauge_12) annotation(Placement(transformation(extent = {{142.14117647058822,45.11764705882353},{162.14117647058822,65.11764705882354}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Templates.ACload aCload2(aC_LoadIdealWye(P_nom = 100,V_nom = 277),ac_schedule(tableName = "Mechanical",fileName = .ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/loads_15min.txt"),timeScale = 3600,columns = {3})) annotation(Placement(transformation(extent = {{10.0,-10.0},{-10.0,10.0}},origin = {-5.039999999999999,149.56},rotation = 90.0)));
    .HPF.Templates.ACload aCload3(ac_schedule(tableName = "Mechanical",fileName = .ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/loads_15min.txt"),timeScale = 3600,columns = {2}),aC_LoadIdealWye(P_nom = 100,V_nom = 277)) annotation(Placement(transformation(extent = {{10.0,-10.0},{-10.0,10.0}},origin = {-35.61,143.27},rotation = 90.0)));
    .HPF.Sources.DC.FixedVoltage_VariablePower fixedVoltage_VariablePower(v_out = 660) annotation(Placement(transformation(extent = {{-10,10},{10,-10}},origin = {-58.66,-68.68},rotation = -90)));
    .Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(tableOnFile = true,tableName = "pv_profile",fileName = .ModelicaServices.ExternalReferences.loadResource("modelica://PrototypeBuildingElectricalModels/Data/LoadProfiles/pv_san_diego_roof.txt"),timeScale = 3600,smoothness = .Modelica.Blocks.Types.Smoothness.ConstantSegments,extrapolation = .Modelica.Blocks.Types.Extrapolation.HoldLastPoint) annotation(Placement(transformation(extent = {{-122.68,-78.68},{-102.68,-58.68000000000001}},origin = {0,0},rotation = 0)));
    .HPF.PowerConverters.ThreePhase.ACDC_3pInverterSimple aCDC_3pInverterSimple(vAngle = 0.52359877559829833278,PF = +0.95,P_nom = 175000,P_stby = 1,VAC_nom = 277,VDC_nom = 660,alpha = 0.004799349,beta = 0.010598212,gamma = 0.016227353,Q1(start = 0)) annotation(Placement(transformation(extent = {{-18.659999999999997,-76.68},{-38.66,-56.68000000000001}},origin = {0,0},rotation = 0)));
    .HPF.Cables.NEC_CableModel nEC_CableModel2(wireGaugeAC = .HPF.Types.WireGaugeAC.gauge_500) annotation(Placement(transformation(extent = {{-11.7,-63.72},{-1.620000000000001,-53.640000000000015}},origin = {0,0},rotation = 0)));
    .HPF.Cables.NEC_CableModel nEC_CableModel3(wireGaugeAC = .HPF.Types.WireGaugeAC.gauge_500) annotation(Placement(transformation(extent = {{-11.7,-69.72},{-1.620000000000001,-59.640000000000015}},origin = {0,0},rotation = 0)));
    .HPF.Cables.NEC_CableModel nEC_CableModel4(wireGaugeAC = .HPF.Types.WireGaugeAC.gauge_500) annotation(Placement(transformation(extent = {{-11.7,-75.72},{-1.620000000000001,-65.64000000000001}},origin = {0,0},rotation = 0)));
    .HPF.DC.Ground ground4 annotation(Placement(transformation(extent = {{-54.66,-112.68},{-34.66,-92.68}},origin = {0,0},rotation = 0)));
    .Modelica.Blocks.Math.Gain gain(k = 0) annotation(Placement(transformation(extent = {{-95.2,-78.5},{-75.2,-58.5}},origin = {0,0},rotation = 0)));
equation
    ...
    connect(aCload3.hPin_A,d1Y.pinSec_A) annotation(Line(points = {{-37.21,127.87},{-37.21,121.87},{-12,121.87},{-12,2},{-18,2}},color = {92,53,102}));
    connect(aCload3.hPin_B,d1Y.pinSec_B) annotation(Line(points = {{-35.21,127.87},{-35.21,121.87},{-12,121.87},{-12,-6},{-18,-6}},color = {92,53,102}));
    connect(aCload3.hPin_C,d1Y.pinSec_C) annotation(Line(points = {{-33.21,127.87},{-33.21,121.87},{-12,121.87},{-12,-14},{-18,-14}},color = {92,53,102}));
    connect(aCload3.hPin_N,d1Y.pinSec_N) annotation(Line(points = {{-30.61,127.87},{-12,127.87},{-12,-22},{-18,-22}},color = {117,80,123}));
    connect(aCload2.hPin_A,d1Y.pinSec_A) annotation(Line(points = {{-6.64,134.16},{-6.64,2},{-18,2}},color = {92,53,102}));
    connect(aCload2.hPin_B,d1Y.pinSec_B) annotation(Line(points = {{-4.64,134.16},{-4.64,-6},{-18,-6}},color = {92,53,102}));
    connect(aCload2.hPin_C,d1Y.pinSec_C) annotation(Line(points = {{-2.64,134.16},{-2.64,-14},{-18,-14}},color = {92,53,102}));
    connect(aCload2.hPin_N,d1Y.pinSec_N) annotation(Line(points = {{-0.04,134.16},{5.96,134.16},{5.96,-22},{-18,-22}},color = {117,80,123}));
    connect(aCDC_3pInverterSimple.hPin_A,nEC_CableModel2.pin_p) annotation(Line(points = {{-18.659999999999997,-58.68000000000001},{-11.71,-58.68000000000001}},color = {92,53,102}));
    connect(aCDC_3pInverterSimple.hPin_B,nEC_CableModel3.pin_p) annotation(Line(points = {{-18.659999999999997,-63.68000000000001},{-15.18,-63.68000000000001},{-15.18,-64.68},{-11.71,-64.68}},color = {92,53,102}));
    connect(aCDC_3pInverterSimple.hPin_C,nEC_CableModel4.pin_p) annotation(Line(points = {{-18.659999999999997,-68.68},{-15.18,-68.68},{-15.18,-70.68},{-11.71,-70.68}},color = {92,53,102}));
    connect(fixedVoltage_VariablePower.p,aCDC_3pInverterSimple.pin_p) annotation(Line(points = {{-58.66,-58.68000000000001},{-58.66,-52.68000000000001},{-44.66,-52.68000000000001},{-44.66,-58.68000000000001},{-38.66,-58.68000000000001}},color = {0,0,255}));
    connect(fixedVoltage_VariablePower.n,aCDC_3pInverterSimple.pin_n) annotation(Line(points = {{-58.66,-78.68},{-58.66,-84.68},{-44.66,-84.68},{-44.66,-74.68},{-38.66,-74.68}},color = {0,0,255}));
    connect(aCDC_3pInverterSimple.pin_n,ground4.p) annotation(Line(points = {{-38.66,-74.68},{-44.66,-74.68},{-44.66,-92.68}},color = {0,0,255}));
    connect(combiTimeTable.y[1],gain.u) annotation(Line(points = {{-101.68,-68.68},{-97.2,-68.5}},color = {0,0,127}));
    connect(gain.y,fixedVoltage_VariablePower.p_out) annotation(Line(points = {{-74.2,-68.5},{-70.43,-68.5},{-70.43,-68.68},{-66.66,-68.68}},color = {0,0,127}));
    connect(aCDC_3pInverterSimple.hPin_N,ground.pin) annotation(Line(points = {{-18.66,-74.68},{-12.66,-74.68},{-12.66,-36},{-50,-36},{-50,-42}},color = {117,80,123}));
    connect(nEC_CableModel2.pin_n,d1Y.pinSec_A) annotation(Line(points = {{-1.62,-58.68},{4.38,-58.68},{4.38,2},{-18,2}},color = {117,80,123}));
    connect(d1Y.pinSec_B,nEC_CableModel3.pin_n) annotation(Line(points = {{-18,-6},{4.38,-6},{4.38,-64.68},{-1.62,-64.68}},color = {92,53,102}));
    connect(d1Y.pinSec_C,nEC_CableModel4.pin_n) annotation(Line(points = {{-18,-14},{4.38,-14},{4.38,-70.68},{-1.62,-70.68}},color = {92,53,102}));
    connect(d1Y.pinSec_C,nEC_CableModel9.pin_n) annotation(Line(points = {{-18,-14},{28,-14},{28,-48.75},{22,-48.75}},color = {92,53,102}));
    connect(d1Y.pinSec_B,nEC_CableModel8.pin_n) annotation(Line(points = {{-18,-6},{0,-6},{0,1.25},{32,1.25},{32,-14.75},{26,-14.75}},color = {92,53,102}));
    connect(d1Y.pinSec_A,nEC_CableModel7.pin_n) annotation(Line(points = {{-18,2},{34,2},{34,26},{28,26}},color = {92,53,102}));
