...
model HarmonicSource_MATLAB_Implementation "Harmonic source"
  ...
  parameter Real argS1 = 0 "Phase angle for fundamental apparent power";
...
/*
    ...
    Complex(g_h_out, 0)
  */
  i[2:systemDef.numHrm].re = nu .* exp(gamma .* systemDef.hrms[2:systemDef.numHrm]);
  i[2:systemDef.numHrm].im = {0.0 for i in 2:systemDef.numHrm};
  annotation (
