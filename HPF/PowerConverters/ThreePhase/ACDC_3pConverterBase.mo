...
partial model ACDC_3pConverterBase
  ...
  parameter Modelica.Units.SI.Voltage VDC_nom=24 "Nominal DC operating voltage"
    annotation (Dialog(group="Device Ratings"));
  final parameter Modelica.Units.SI.Current IAC_nom=P_nom/3/VAC_nom
    "Nominal AC line current";
  final parameter Modelica.Units.SI.Current IDC_nom=P_nom/VDC_nom
    "Nominal DC current";
  // Initialization
  parameter Modelica.Units.SI.Angle vAngle=0
    "Nominal phase A voltage angle for solver init"
    annotation (Dialog(group="Initialization"));
  final parameter Modelica.Units.SI.Angle vAngle_B=vAngle -
      Modelica.Units.Conversions.from_deg(120);
  final parameter Modelica.Units.SI.Angle vAngle_C=vAngle +
      Modelica.Units.Conversions.from_deg(120);
  // AC terminals
