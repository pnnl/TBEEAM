...
partial model ACDC_1pConverterBase
  ...
  parameter Modelica.Units.SI.Voltage VAC_nom=120
    "Nominal AC operating voltage" annotation (Dialog(group="Device Ratings"));
  parameter Modelica.Units.SI.Voltage VDC_nom=24 "Nominal DC operating voltage"
    annotation (Dialog(group="Device Ratings"));
  final parameter Modelica.Units.SI.Current IAC_nom=P_nom/VAC_nom
    "Nominal AC current";
