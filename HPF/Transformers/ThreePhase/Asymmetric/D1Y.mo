...
model D1Y
  ...
  parameter Modelica.Units.SI.Resistance Rp[3]={1e-3,1e-3,1e-3}
    "Primary winding resistance (at fundamental)";
  parameter Modelica.Units.SI.Reactance Xp[3]={1e-3,1e-3,1e-3}
    "Primary winding reactance";
  parameter Modelica.Units.SI.Resistance Rs[3]={1e-3,1e-3,1e-3}
    "Secondary winding resistance";
  parameter Modelica.Units.SI.Reactance Xs[3]={1e-3,1e-3,1e-3}
    "Secondary winding reactance";
  parameter Modelica.Units.SI.Resistance Rc[3]={1e5,1e5,1e5} "Core resistance";
  parameter Modelica.Units.SI.Reactance Xm[3]={1e5,1e5,1e5}
